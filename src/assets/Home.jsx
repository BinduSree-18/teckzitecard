...
const Home = () => {
  ...
  return (
    <div className="h-full w-full overflow-x-hidden  top-0 left-0">
        <div className="flex justify-between  text-white font-bold bg-[#11101d]">
           ...
           <div className="flex flex-row gap-4 hidden md:flex pt-12">
            ...
            <p className="cursor-pointer pl-2"><Link to="/AllCourses">AllCourses</Link></p>
            <p className="cursor-pointer pl-2"><Link to="/CurrentAffairs">CurrentAffairs</Link></p>
        ...
        </div>
        {
            isMenuOpen &&(
                ...
                <p className="cursor-pointer pl-2"><Link to="/Home">Home</Link></p>
                  ...
                  <p className="cursor-pointer"><Link to="/AllCourses">AllCourses</Link></p>
                  <p className="cursor-pointer"><Link to="/CurrentAffairs">CurrrentAffairs</Link></p>
